...
public class BookSellfol extends AppCompatActivity {
    private ListView listView;
    DatabaseReference databaseReference;
    private FirebaseAuth mAuth;
    FirebaseUser firebaseUser;
    private List<userbookclass> bookslists;
    private DBfol contributionAdapter;
    String profileid;
    ImageButton textingpro;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_book_sellfol);
        ...
        contributionAdapter = new DBfol(BookSellfol.this, bookslists);
        textingpro=findViewById(R.id.upload);
        textingpro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent inten=new Intent(BookSellfol.this, TextingActivity1.class);
                startActivity(inten);
            }
        });
