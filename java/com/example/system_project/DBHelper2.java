...
public class DBHelper2 extends ArrayAdapter<userbookclass> {
    private Activity context;
    private List<userbookclass> booklistcontri;

    public DBHelper2(Activity context,List<userbookclass> booklistcontri) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference().child("booksell").child(profileid)
